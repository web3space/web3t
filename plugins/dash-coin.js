...
(function(){
  var mainnet, testnet, txTypes, color, type, enabled, name, token, image, usdInfo, out$ = typeof exports != 'undefined' && exports || this;
  out$.mainnet = mainnet = {
    decimals: 8,
    txFee: '0.0004',
    txFeeOptions: {
