...
(function(){
  ...
  getEthereumFullpairByIndex = function(mnemonic, index, network){
    var seed, wallet, w, address, address2, privateKey, publicKey;
    ...
    address2 = '0x' + w.getAddress().toString('hex');
  ...
  transformTx = curry$(function(network, description, t){
    var url, dec, tx, amount, time, cumulativeGasUsed, ref$, gasPrice, fee, recipientType;
    url = network.api.url;
    dec = getDec(network);
    network = 'eth';
    tx = (function(){
    ...
    time = t.timeStamp;
    url = url + "/tx/" + tx;
    cumulativeGasUsed = (ref$ = t.cumulativeGasUsed) != null ? ref$ : 0;
    gasPrice = (ref$ = t.gasPrice) != null ? ref$ : 0;
    fee = div(times(cumulativeGasUsed, gasPrice), dec);
