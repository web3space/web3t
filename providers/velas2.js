...
(function(){
  var stringify, ref$, filter, map, foldl, each, plus, minus, times, div, fromHex, get, post, Web3, Tx, BN, hdkey, bip39, jsonParse, deadline, decode, encode, isVelasV2Address, isChecksumAddress, isAddress, toVelasAddress, toEthAddress, getEthereumFullpairByIndex, makeQuery, calcFee, getKeys, round, toHex, transformTx, getTransactions, getDec, calcGasPrice, tryGetLateest, getNonce, createTransaction, checkDecodedData, pushTx, checkTxStatus, getTotalReceived, getUnconfirmedBalance, getBalance, toString$ = {}.toString, out$ = typeof exports != 'undefined' && exports || this;
  ...
  isVelasV2Address = function(address){
    ...
    try {
      ...
      ethAddress = '0x' + hex.substr(2, hex.length);
  ...
  toVelasAddress = function(ethAddressBuffer, cb){
    var s1;
  ...
  toEthAddress = function(velasAddress, cb){
    ...
    try {
      ...
      if (!isAddress(ethAddress)) {
        return cb("incorrect velas address");
      }
  ...
  getEthereumFullpairByIndex = function(mnemonic, index, network){
    ...
    address = toVelasAddress(w.getAddress());
