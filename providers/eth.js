...
(function(){
  var stringify, ref$, filter, map, foldl, each, plus, minus, times, div, fromHex, get, post, Tx, BN, jsonParse, deadline, hdkey, bip39, getEthereumFullpairByIndex, makeQuery, calcFee, getKeys, round, toHex, transformTx, getTransactions, getDec, calcGasPrice, tryGetLateest, getNonce, isAddress, createTransaction, checkDecodedData, pushTx, checkTxStatus, getTotalReceived, getUnconfirmedBalance, getBalance, out$ = typeof exports != 'undefined' && exports || this, toString$ = {}.toString;
    ...
    return getNonce({
      ...
      return calcGasPrice({
        ...
        return makeQuery(network, 'eth_getBalance', [account.address, 'latest'], function(err, balance){
          var balanceEth, toSend, gasEstimate, tx, rawtx;
          if (err != null) {
            return cb(err);
          }
