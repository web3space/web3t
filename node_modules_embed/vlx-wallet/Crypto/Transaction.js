...
var Errors;
(function (Errors) {
    Errors["InsufficientFunds"] = "amount + commission smaller than value";
})(Errors || (Errors = {}));
var Transaction = /** @class */ (function (_super) {
    ...
    function Transaction(sodium, unspents, amount, velasKey, changeAddress, to, commission) {
        ...
        _this.generateHash = function () {
            ...
            var payloadIn = _this.tx_in.reduce(function (res, txIn) {
                ...
                p2 = Buffer.concat([p2, utils_1.BigIntToBufferLE(txIn.previous_output.value, 8)]);
        ...
        var totalin = unspents.reduce(function (res, po) { return res.add(po.value); }, bigInt(0));
        var index = 0;
        _this.tx_out = [];
        ...
        var change = totalin.minus(amount).minus(commission);
        console.log('change.compare(bigInt(0))', change, change.compare(bigInt(0)));
        if (change.compare(bigInt(0)) === -1) {
            console.log("amount: " + amount + ", commission:" + commission + ", total in: " + totalin);
            throw new Error(Errors.InsufficientFunds);
        }
        else if (change.compare(bigInt(0)) === 1) {
    ...
    Transaction.hashOut = function (val) {
        ...
        var value = utils_1.BigIntToBufferLE(val.value, 8);
